...
if (this.defaultOffset != 8396800) this.setOffsets(i, this.defaultOffset);
...
this.pickedX = x;
this.pickedY = y;
this.pickedOffset = (this.offsets == null || this.pickedAtom >= this.offsets.length ? 8396800 : this.offsets[this.pickedAtom]);
return true;
}return false;
