...
if (name.endsWith("#_DOCACHE_")) name = name.substring(0, name.length - "#_DOCACHE_".length);
...
} else if (JU.AU.isAB(nameOrBytes)) {
bytes = nameOrBytes;
...
break;
case 60:
if (line.startsWith("<?xml") && line.indexOf("<jvxl ") > 0) return "JvxlXml";
