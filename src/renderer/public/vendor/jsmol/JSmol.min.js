...
function(c){a.loadFileAsynchronously(null,c,null,null)};a.promptDialog=null;a.dialogHTML='<dialog id="Jmol.dialogDiv"><div id="Jmol.dialogMsgDiv" style="margin-bottom:1em;white-space:pre"></div><form method="dialog" id="Jmol.dialogBtns"></form></dialog>';a.promptAsynchronously=function(c,e,h,b){a.promptDialog||(a.$after("body",a.dialogHTML),a.promptDialog=document.getElementById("Jmol.dialogDiv"));if(c){a.promptDialog.returnValue=null;a.promptDialog.addEventListener("close",function N(){a.promptDialog.removeEventListener("close",
N);var e=a.promptDialog.returnValue;c.setData("null"==e?null:e)});document.getElementById("Jmol.dialogMsgDiv").textContent=h;e=document.getElementById("Jmol.dialogBtns");e.innerHTML="";for(h=0;h<b.length;h++){var d=document.createElement("button");d.setAttribute("value",b[h]);d.textContent=b[h];d.style.margin="0 1em";e.appendChild(d)}a.promptDialog.showModal()}};a.loadFileAsynchronously=function(c,e,h,b){if(h&&0!=h.indexOf("?")){var d=h;h=a._checkFileName(e,h);var f=function(f){a._setData(c,h,d,f,
b,e)},f=a._checkCache(e,h,f);0<=h.indexOf("|")&&(h=h.split("|")[0]);return null==f?null:a._getFileData(h,f)}if(!a.featureDetection.hasFileReader)return c?c.setData("Local file reading is not enabled in your browser",null,null,b,e):alert("Local file reading is not enabled in your browser");e._localReader||(f='<div id="ID" style="z-index:'+a._getZ(e,"fileOpener")+';position:absolute;background:#E0E0E0;left:10px;top:10px"><div style="margin:5px 5px 5px 5px;"><button id="ID_loadurl">URL</button><input type="file" id="ID_files" /><button id="ID_loadfile">load</button><button id="ID_cancel">cancel</button></div><div>',
...
a.indexOf(" | ")&&(a=a.replace(/\ \|\ /g,"\n")),a;var h=(new Function("return "+a))();return!h?null:e&&void 0!=h[e]?h[e]:h};a._sortMessages=function(a){function e(a,c){return a[0]<c[0]?1:a[0]>c[0]?-1:0}if(!a||"object"!=typeof a)return[];for(var h=[],b=a.length-1;0<=b;b--)for(var d=0,f=a[b].length;d<f;d++)h[h.length]=a[b][d];if(0!=h.length)return h=h.sort(e)};a._setMouseOwner=function(c,e){null==c||e?(a._mouseOwner=c)&&c._applet&&(a._lastAppletID=c._applet._id):a._mouseOwner==c&&(a._mouseOwner=null)};
...
l.htDialogs[a.id]=a};l.setDialog=function(c){a._setMouseOwner(null);a.$remove(c.id);var b=c.id+"_mover",h=a._$(b),d;h[0]?(h.html(c.html),d=h[0].jd):(a.$after("body","<div id='"+b+"' style='position:absolute;left:0px;top:0px;'>"+c.html+"</div>"),d=new l.JSDialog,h=a._$(b),c.container=h,d.applet=c.manager.vwr.html5Applet,d.setContainer(h),d.dialog=c,d.setPosition(),d.dragBind(!0),h[0].jd=d);a.$bind("#"+c.id+" .JButton","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JComboBox",
"mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JCheckBox","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JTextField","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JTable","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JScrollPane","mousedown touchstart",function(){d.ignoreMouse=!0});a.$bind("#"+c.id+" .JEditorPane","mousedown touchstart",function(){d.ignoreMouse=!0})};l.setSelected=function(c){a.$prop(c.id,
"checked",!!c.selected)};l.setSelectedIndex=function(c){a.$prop(c.id,"selectedIndex",c.selectedIndex)};l.setText=function(c){a.$prop(c.id,"value",c.text)};l.setVisible=function(c){a.$setVisible(c.id,c._visible)};l.setEnabled=function(c){a.$setEnabled(c.id,c.enabled)};l.click=function(c,b){var h=l.htDialogs[c.id];if(h){var d=h.toString();if(0<=d.indexOf("JCheck"))h.selected=c.checked;else if(0<=d.indexOf("JCombo"))h.selectedIndex=c.selectedIndex;else if(null!=h.text&&(h.text=c.value,b&&13!=(b.charCode||
b.keyCode)))return}d=l.htDialogs[a.$getAncestorDiv(c.id,"JDialog").id];d.manager.actionPerformed(h?h.name:d.registryKey+"/"+c.id)};l.setFront=function(c){var b=c.manager.vwr.html5Applet;c.zIndex!=a._getZ(b,"dialog")&&(c.zIndex=a._incrZ(b,"dialog"));c.container&&((c.container[0]||c.container).style.zIndex=c.zIndex)};l.hideMenus=function(a){if(a=a._menus)for(var b in a)a[b]._visible&&l.hideMenu(a[b])};l.windowClosing=function(c){c=l.htDialogs[a.$getAncestorDiv(c.id,"JDialog").id];c.registryKey?c.manager.processWindowClosing(c.registryKey):
c.dispose()};a._track=function(c){if(a._tracker){try{var b='<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="'+(a._tracker+"&applet="+c._jmolType+"&version="+a._version+"&appver="+a.___JmolVersion+"&url="+encodeURIComponent(document.location.href))+'"></iframe>';a.$after("body",b)}catch(d){}delete a._tracker}return c};var m;a.getProfile=function(a){if(self.Clazz&&self.JSON)return m||Clazz._startProfiling(m=0==arguments.length||a),Clazz.getProfile()};a._getInChIKey=
...
new FileReader,f.onloadend=function(f){if(f.target.readyState==FileReader.DONE){var k="cache://DROP_"+g.name;f=Clazz.newByteArray(-1,f.target.result);if("console_input"==e)k=String.instantialize(f),a.$(b,e).val(0>k.indexOf("\x00")?k:f.length+" bytes");else{k.endsWith(".spt")||b._appletPanel.cacheFileByName("cache://DROP_*",!1);"JSV"==b._viewType||k.endsWith(".jdx")?a.Cache.put(k,f):b._appletPanel.cachePut(k,f);f=a._jsGetXY(b._canvas,d);var j=[null];f&&(!b._appletPanel.setStatusDragDropped||b._appletPanel.setStatusDragDropped(0,
f[0],f[1],k,j))&&b._appletPanel.openFileAsyncSpecialType(k,1,j[0])}}},f.readAsArrayBuffer(g)})}})(Jmol,jQuery);Jmol._debugCode=document&&document.location&&0<=document.location.href.indexOf("j2sdebugcode");
...
e;try{null.hello()}catch(h){if(f=function(a,b,c){c||(c="[^\\s]+");var d=a.indexOf(b);a=a.substring(0,d)+c+a.substring(d+b.length);return RegExp("^"+a+"$")},/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)){var f=h.message.indexOf(":"),s=h.message.indexOf(":",f+2),H=h.message.substr(f+1,s-f-20);e=function(a){return-1!=a.message.indexOf(H)}}else if(-1!=navigator.userAgent.toLowerCase().indexOf("webkit")){var P=f(h.message,"hello");e=function(a){return P.test(a.message)}}else P=f(h.message,"$$o$$"),
e=function(a){return P.test(a.message)}}a.getStackTrace=function(a){a||(a=25);var b="\n",c=arguments.callee,d=0>a;d&&(a=-a);try{for(var e=0;e<a&&(c=c.caller);e++){var f=c.toString?c.toString().substring(0,c.toString().indexOf("{")):"<native method>",b=b+(e+" "+(c.exName?(c.claxxOwner?c.claxxOwner.__CLASS_NAME__+".":"")+c.exName+f.replace(/function /,""):f)+"\n");if(c==c.caller){b+="<recursing>\n";break}if(d)for(var g=c.arguments,h=0;h<g.length;h++){var j=""+g[h];60<j.length&&(j=j.substring(0,60)+
"...");b+=" args["+h+"]="+j.replace(/\s+/g," ")+"\n"}}}catch(k){}return b};a.makeConstructor=function(b,c,d){a.defineMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.overrideConstructor=function(b,c,d){a.overrideMethod(b,"construct",c,d);b.con$truct&&(b.con$truct.index=b.con$truct.stacks.length)};a.defineMethod=function(d,e,f,g){f.exName=e;g=U(g);var h=d.prototype,j=h[e];a._Loader._checkLoad&&N(d,e,g);if(!j||j.claxxOwner===d&&j.funParams==g)return f.funParams=
...
[];for(A=0;A<d.length;A++)e[A]=d[A]instanceof a.CastedNull?null:d[A]}else e=d;d=fx.lastMethod?fx.lastMethod.apply(this,e):null}else{fx.lastParams=f.typeString;fx.lastClaxxRef=e;E=fx.stacks;E||(E=e.prototype[A].stacks);for(var j=!1,h=E.length;0<=--h;)if(j||E[h]===e){var t=E[h].prototype[A],k=f,j=d,ua=fx,l=[],I=!0,m=void 0;for(m in t)if(92==m.charCodeAt(0)){var B=m.substring(1).split("\\");B.length==k.length&&l.push(B);I=!1}else if(I&&"funParams"==m&&t.funParams){m=t.funParams;B=m.substring(1).split("\\");
B.length==k.length&&(l[0]=B);break}if(!(m=0==l.length)){for(var m=k,B=[],n=l.length,F=0;F<n;F++){for(var p=[],sa=!0,s=l[F].length,r=0;r<s;r++)if(p[r]=a.getInheritedLevel(m[r],l[F][r]),0>p[r]){sa=!1;break}sa&&(p[m.length]=F,B.push(p))}if(0==B.length)l=null;else{n=B[0];for(F=1;F<B.length;F++){p=!0;for(r=0;r<m.length;r++)if(n[r]<B[F][r]){p=!1;break}p&&(n=B[F])}l=l[n[m.length]].join("\\")}m=!l}if(m)j=new c;else{t=I?t:t["\\"+l];I=null;if(k.hasCastedNull){I=[];for(k=0;k<j.length;k++)I[k]=j[k]instanceof
a.CastedNull?null:j[k]}else I=j;ua.lastMethod=t;j=t.apply(this,I)}if(!(j instanceof c)){d=j;break a}j=!0}"construct"!=A&&V(this,e,A,f.typeString);d=void 0}}return d};j.methodName=e;j.claxxReference=d;j=h[e]=j;e=[];for(h=0;h<l.length;h++)e[h]=l[h];j.stacks=e}l=j.stacks;0>T(l,d)&&l.push(d);k&&(k.claxxOwner===d?(j[k.funParams]=k,k.claxxOwner=null,k.funParams=null):k.claxxOwner||(j["\\unknown"]=k));f.exClazz=d;j[g]=f;return j};duplicatedMethods={};var N=function(b,c,d){var e=b.prototype[c];if(e&&(e.claxxOwner||
...
a.BYTES_PER_ELEMENT=4;return a};!0==(a.haveFloat64=!!(self.Float64Array&&self.Float64Array!=Array))?Float64Array.prototype.sort||(Float64Array.prototype.sort=Array.prototype.sort):(Float64Array=function(a){return aa(a,64)},Float64Array.prototype.sort=Array.prototype.sort,Float64Array.prototype.toString=function(){return"[object Float64Array]"});Float64Array.prototype.slice||(Float64Array.prototype.slice=function(){return Q.apply(this,arguments)});Float64Array.prototype.clone=function(){return this.slice()};
...
2))}c&&(C["@"+a]=c);d&&!j&&!window[a+".registered"]?(y++,"java"==a&&(a="core"),b.loadClass(a+".package",function(){0==--y&&ea()},!0,!0,1)):e&&e()}};a.loadClass=function(c,d,e){self.Class||(Class=a,Class.forName=a._4Name,JavaObject=a._O);return c&&b.loadClass(c,d,!0,e,1)};b.loadClass=function(c,f,g,j,h){h||(h=0);null==j&&(j=!1);if("boolean"==typeof f)return a.evalType(c);null!=window["java.registered"]&&!C["@java"]&&b.loadPackage("java");b.keepOnLoading=!0;if(!g&&(y&&c.lastIndexOf(".package")!=c.length-
8||0!=c.indexOf("java.")&&!isClassDefined(la)))ma.push([c,f]);else if((h=isClassDefined(c))||z["@"+c]){if(h&&f&&(g=D(c),!g||g.status>=n.STATUS_LOAD_COMPLETE))j?window.setTimeout(f,25):f()}else{var k=b.getClasspathFor(c);h=e[k];if(!h)for(j=w.length;0<=--j;)if(w[j].path==k||w[j].name==c){h=!0;break}if(h){if(f&&(h=D(c)))if(h.onLoaded){if(f!=h.onLoaded){var l=h.onLoaded,m=f;h.onLoaded=function(){l();m()}}}else h.onLoaded=f}else{h=a.unloadedClasses[c]&&D(c)||new n;h.name=c;h.path=k;h.isPackage=k.lastIndexOf("package.js")==
k.length-10;fa(k,c,h);h.onLoaded=f;h.status=n.STATUS_KNOWN;c=!1;for(j=w.length;0<=--j;)if(w[j].status!=n.STATUS_LOAD_COMPLETE){c=!0;break}if(h.isPackage){for(j=w.length;0<=--j&&!w[j].isPackage;)w[j+1]=w[j];w[++j]=h}else c&&w.push(h);if(!c){var t=!1;f&&(t=K,K=!0);g&&(f=null);ba(d,h,!0);G(h,h.path,h.requiredBy,!1,f?function(){K=t;f()}:null)}}}};b.loadPackage=function(a,c){c||(c=null);window[a+".registered"]=!1;b.loadPackageClasspath(a,b.J2SLibBase||(b.J2SLibBase=b.getJ2SLibBase()||"j2s/"),!0,c)};b.jarClasspath=
...
n.STATUS_DECLARED&&P(j[f],c))return!0}d.length=e;return!1};b._classCountPending=0;b._classCountOK=0;b._classPending={};b.showPending=function(){var a=[],c;for(c in b._classPending){var d=D(c);d?(a.push(d),System.out.println(Q("","",d,"",0))):alert("No node for "+c)}return a};var Q=function(a,b,c,d,e){b+="--"+c.name;a+=b+"\n";if(5<e)return a+(d+" ...\n");d+="\t";a+=d+"status: "+c.status+"\n";if(c.parents&&c.parents.length&&c.parents[0]&&c.parents[0].name){a+=d+"parents: "+c.parents.length+"\n";for(var f=
0;f<c.parents.length;f++)a=Q(a,b,c.parents[f],d+"\t",e+1);a+="\n"}return a};updateNode=function(a){if(!a.name||a.status>=n.STATUS_LOAD_COMPLETE)R(a);else{var c=!0;if(a.musts.length&&a.declaration)for(var d=a.musts.length,e=d;0<=--e;){var f=a.musts[e];f.requiredBy=a;if(f.status<n.STATUS_DECLARED&&isClassDefined(f.name)){var g=[];f.status=n.STATUS_LOAD_COMPLETE;R(f);if(f.declaration&&f.declaration.clazzList){for(var h=0,j=f.declaration.clazzList,k=j.length;h<k;h++){var l=D(j[h]);l&&(l.status!=n.STATUS_LOAD_COMPLETE&&
l!==f)&&(l.status=f.status,l.declaration=null,R(l),l.onLoaded&&g.push(l))}f.declaration=null}f.onLoaded&&g.push(f);for(h=0;h<g.length;h++)if(j=g[h].onLoaded)g[h].onLoaded=null,j()}else f.status==n.STATUS_CONTENT_LOADED&&updateNode(f),f.status<n.STATUS_DECLARED&&(c=!1);a.musts.length!=d&&(e=d=a.musts.length,c=!0)}if(c){if(a.status<n.STATUS_DECLARED){if(e=a.declaration)e(),e.executed=!0;b._checkLoad&&b._classPending[a.name]&&(delete b._classPending[a.name],b._classCountOK,b._classCountPending--);a.status=
...
null==a?"null\r\n":a+"\r\n")};y.out.write=function(a,b,c){y.out.print(String.instantialize(a).substring(b,b+c))};y.err.__CLASS_NAME__="java.io.PrintStream";y.err.print=function(a){p.consoleOutput(a,"red")};y.err.println=function(a){p.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};y.err.write=function(a,b,c){y.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2026-07-12 18:03:31 -0500 (Sun, 12 Jul 2026) $";
Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="16.4.15";
